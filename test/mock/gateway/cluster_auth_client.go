...
// Source: gitlab.figo.systems/platform/monoskope/monoskope/pkg/api/gateway (interfaces: ClusterAuthClient)
...
import (
	...
	gateway "gitlab.figo.systems/platform/monoskope/monoskope/pkg/api/gateway"
