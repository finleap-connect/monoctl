...
// Source: gitlab.figo.systems/platform/monoskope/monoskope/pkg/api/domain (interfaces: ClusterClient,Cluster_GetAllClient)
...
import (
	...
	domain "gitlab.figo.systems/platform/monoskope/monoskope/pkg/api/domain"
