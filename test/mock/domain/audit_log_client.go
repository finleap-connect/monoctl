...
// Source: github.com/finleap-connect/monoskope/pkg/api/domain (interfaces: AuditLogClient,AuditLog_GetByDateRangeClient,AuditLog_GetUserActionsClient,AuditLog_GetUsersOverviewClient)
