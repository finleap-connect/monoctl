...
require (
	...
	gitlab.figo.systems/platform/monoskope/monoskope v0.0.0
...
replace gitlab.figo.systems/platform/monoskope/monoskope => gitlab.figo.systems/platform/monoskope/monoskope.git v0.0.27-rc0
